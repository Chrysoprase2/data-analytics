...
\subsection*{Modellvergleich und Residuendiagnostik}
...
\subsection*{Robustheit der Schätzung}
...
\subsection*{Zusammenfassung der Modellergebnisse}
...
\subsection*{Korrelations-Heatmap}
Die folgende Abbildung \autoref{fig:spearman correlation} zeigt die Spearman-Korrelationskoeffizienten aller untersuchten Merkmale im Datensatz pro Merkmal.
Beispielsweise lässt sich erkennen, dass mehr Personen in Klasse G und H (Mittelschicht) negativ mit der Armutsrate korrelieren.
Wir sehen auch, dass die Anzahl der Kinder weder durch die Klassenzugehörigkeit, noch durch die Armutsrate erklärt wird.
