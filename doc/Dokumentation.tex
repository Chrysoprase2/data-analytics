...
\unilogo{\includegraphics[scale=1]{FHDW-Logo.eps}} 
...
\input{contents/kapitel/00_selbststaendigkeit}
\tableofcontents
...
\input{contents/kapitel/01_einleitung}
\input{contents/kapitel/02_methodik}
\input{contents/kapitel/03_vorverarbeitung}
\input{contents/kapitel/04_analyse}
\input{contents/kapitel/05_ergebnisse}
\input{contents/kapitel/06_handlungsempfehlungen}

% % --- ANHANG (Appendix) ---
\appendix % Schaltet hier auf Anhang-Kapitel um (Kapitel A, B, C...)

\input{contents/kapitel/anhang} 

% --- RÜCKTEIL (Backmatter) ---
% ( Bibliografie, die wir nicht brauchen)
\backmatter
