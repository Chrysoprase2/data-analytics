...
\begin{frame}{Güte und Belastbarkeit des Modells}
    \begin{itemize}
        ...
        \item Daten teilweise intransparent
...
\begin{frame}{Learnings}
    \begin{itemize}
        \item nicht in Daten verlieren
        \item Vorsicht: \textcolor{red}{Schluss historischer Daten auf Gesellschaft}
        \item Vorsicht: \textcolor{red}{Arbeit mit Sekundärdaten}
    \end{itemize}
\end{frame}
